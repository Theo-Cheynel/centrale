...
class RateResource(Resource):
    ...
    @staticmethod
    @swag_from("../swagger/rate/GET.yml")
    ...
    @staticmethod
    @parse_params(
        Argument("rating", location="json", required=True, help="The rating of the movie by the user")
    )
    @swag_from("../swagger/rate/POST.yml")
    ...
    @swag_from("../swagger/rate/PUT.yml")
